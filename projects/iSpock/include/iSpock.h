...
/** An object encapsulating communication with the "SPOCK" Rabbit3000 sensor
    module in the U of I YellowSub AUV
*/
//=============================================================================
...
private:
    ...
    */
    ...
    uint16_t m_SpockTCPPort;        /**< Network port to connect to on the SPOCK
                                         module */
    uint16_t m_SpockUDPPort;        /**< Network port to receive UDP sensor packets
                                         from SPOCK on */
