...
public:
    ...
    *
    * @param TimeStamp_sec
    *   Local (epoch) time in seconds when the packet was received.
    */
    ...
    */
   virtual void OnConnectionEvent( ConnectionEventId EventId,
                                   BunnySockNode& Node,
                                   double TimeStamp_sec) = 0;
