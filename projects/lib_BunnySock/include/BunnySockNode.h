...
public:
	...
	//=========================================================================
	/** Creates a node and registers a specified listener */
	BunnySockNode( BunnySockListener* pListener, uint16_t DeviceId = 0,
	 ...
	 */
	void AddListener( BunnySockListener* pListener );
	 ...
	 *
	 * @param pListener
	 * 	A pointer to the object to un-register
	 */
	...
	void SetDeviceId( uint16_t DeviceId )	{ m_DeviceId = DeviceId; }

	//=========================================================================
	/** Returns the node's device ID */
	uint16_t GetDeviceId( void )	{ return m_DeviceId; }
...
protected:
	...
	void ReportConnectionEvent( int EventId );
