...
public:
	 ...
	 */
	bool StartRecording( int16_t VehicleID, int16_t MissionID,
	 ...
	 *  called
	 */
	int GetEngineStatus( void ) const { return m_DAQStatus; }
	 ...
	 */
	bool SendTelemetry( float North, float East, float Depth,
