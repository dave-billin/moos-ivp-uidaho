...
//=============================================================================
YellowSubDAQModule::YellowSubDAQModule( string& sHostName, uint16_t Port,
...
//=============================================================================
bool YellowSubDAQModule::StartRecording( int16_t VehicleID,
										 int16_t MissionID, int16_t RunID,
										 int16_t NudgeID )
{
...
//=============================================================================
void YellowSubDAQModule::OnConnectionEvent( int EventId, BunnySockNode& Node,
									 	    double TimeStamp_sec )
{
	string s;
