 ...
 *
 * @brief
 *   Implementation of the ActuatorController class used in the University of
 *   Idaho MOOS AUV
 *
...
ActuatorController::ActuatorController()
 : m_HeadingControlIsEnabled( true ),
...
//=============================================================================
void ActuatorController::Process( PrecisionTimeInterval const& dt,
